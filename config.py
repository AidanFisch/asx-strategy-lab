...
# Small "serving" DB with only the tables the live monitor needs (plans + the
# validation/analysis summaries). Committed to git so the daily cloud run works
# without shipping the 60MB+ research leaderboard. Regenerated by serving.py.
SERVING_DB = PROJECT_ROOT / "results" / "serving.db"
